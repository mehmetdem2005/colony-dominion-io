...
3. **Sert üst sınır**: sunucu her hâlükârda `MAX_MATCH_MINUTES` (varsayılan 45 dk)
...
> "max deployment duration" (örn. 60 dk) koy. Kod zaten 45 dk'da kapanır; bu
...
- Hiçbir deployment 45 dk'yı geçmemeli.
