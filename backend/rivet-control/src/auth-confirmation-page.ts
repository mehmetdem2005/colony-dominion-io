  ...
  <style>
    ...
    * { box-sizing: border-box; }
    body {
      ...
      background:
        radial-gradient(circle at 50% 18%, rgba(241, 184, 59, .12), transparent 36%),
    ...
    html[data-state="error"] .mark { border-color: #ff7469; background: rgba(255, 116, 105, .1); color: #ff7469; }
    html[data-state="error"] .eyebrow { color: #ff7469; }
    html[data-state="error"] button { border-color: #ff9b93; background: #ff7469; color: #220a08; }
  </style>
</head>
<body>
  <main>
    ...
    <button type="button" id="close">SEKMEYİ KAPAT</button>
    <small>Tarayıcı sekmeyi otomatik kapatamazsa geri tuşuyla oyuna dönebilirsin.</small>
  </main>
  <script>
    (() => {
...
export function authConfirmationResponse(): Response {
